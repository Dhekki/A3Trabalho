...
public class Programa {
    public static void main(String[] args) {
        ...
        //Instanciação do Array list, Declaração da classe Student
        ...
        personList.add(new Student("Cleber Paralelepipedo ", 16, 'M', "1242526949", 1));
        personList.add(new Student("Joao", 19, 'M', "1242736987", 3));
        personList.add(new Student("Larissa", 20, 'F', "1842526987", 4));
        personList.add(new Teacher("Julia", 41, 'F', "1241626987", "Matemática", 1900.00));
        personList.add(new Teacher("Clara", 17, 'F', "1242521787", "História", 1800.00));
